(function() {
    ...
    var Earth = function() {
        ...
        var northPolePositions = northPoleGeom.attributes.position;
        if (northPolePositions) {
            for (var i = 0; i < northPolePositions.count; i++) {
                var y = northPolePositions.getY(i);
                if (i === 0) {
        ...
        var southPolePositions = southPoleGeom.attributes.position;
        if (southPolePositions) {
            for (var i = 0; i < southPolePositions.count; i++) {
                var y = southPolePositions.getY(i);
                if (i === 0) {
        ...
        contiGeom = contiGeom.mergeVertices();

        var l = contiGeom.attributes.position.count;
    ...
    var Sputnik = function() {
        ...
        var wingsPositions = wingsGeom.attributes.position;
        if (wingsPositions) {
            for(var i = 0; i < wingsPositions.count; i++) {
                if (i % 2 === 0) {
                    var z = wingsPositions.getZ(i);
